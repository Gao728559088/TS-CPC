...
from src.data_reader.dataset import RawDatasetGeoLife, RawDatasetGeoLife1, RawDatasetSingapore
from src.training_v1 import train,  snapshot
from src.validation_v1 import validation
from src.model.model import CDCK2, CDCK5, CDCK2ForJakartaIos, CDCK2ForSingapore
...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Jakarta_ios/jakartaIos.hdf5')
    parser.add_argument('--train', default='dataGenerate/jakartaIosGenerate/jakartaIosTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/jakartaIosGenerate/jakartaIosVal.txt')
 

    parser.add_argument('--logging-dir', default='snapshot/jakartaIos/', help='model save directory')
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[3], help='List of GPUs to use (e.g., --gpus 0 1)')
    ...
    if torch.cuda.is_available() and not args.no_cuda:
        ...
        model = CDCK2ForJakartaIos(args.timestep, args.batch_size, args.trajectory_window).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # Save
        if val_acc >= best_acc and epoch>60: 
        ...
        # drawFromLog(args.logging_dir + run_name + '.log')
    ## end 
