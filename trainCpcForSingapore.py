...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Singapore_ios/singapore.hdf5')
    parser.add_argument('--train', default='dataGenerate/singaporeIosGenerate/singaporeTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/singaporeIosGenerate/singaporeVal.txt')
 

    parser.add_argument('--logging-dir', default='snapshot/singapore/', help='model save directory')
