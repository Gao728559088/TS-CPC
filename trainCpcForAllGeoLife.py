...
from src.model.model import CDCK2ForAllGeoLife, CDCK2ForGeoLife
...
def main():
    ...
    parser.add_argument('--raw', default='dataset/geoLife/1/processedGeolife.hdf5')
    parser.add_argument('--train', default='dataGenerate/allGeolifeGenerate/geoLifeTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/allGeolifeGenerate/geoLifeVal.txt')
