...
def calculate_mean_rank(rank_matrix):
    ...
    for i in range(num_vectors):
            ...
            if (rank_matrix[i, i].item() == 0 or rank_matrix[i, i].item() == 1 ):  
                ranks.append(1.0)
            else:
...
def main():
    ...
    query_hdf5 = 'evalSimilary/jakartaIosForClassSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/jakartaIosForClassSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/jakartaIosForClassSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/jakartaIosForClassSimilary/true_database_data.txt'
