...
from src.model.model import CDCK2ForJakartaAndroid, CDCK2ForJakartaIos, CDCK2ForSingapore
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='snapshot/jakartaAndroid/cdc-2024-09-08_22_47_23-model_best.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/jakartaAndroidSimilary/logs', help='Directory to save log files')
    parser.add_argument('--output-dir', type=str, default='evalSimilary/jakartaAndroidSimilary/heatmaps', help='Directory to save heatmap images')
    args = parser.parse_args()
    
    logger = setup_logger(args.log_dir)
    
    files = [f for f in os.listdir('evalSimilary/jakartaAndroidSimilary/subsetForVal') if f.endswith('.hdf5')]
    mean_ranks = []

    for file in files:
        hdf5_file = os.path.join('evalSimilary/jakartaAndroidSimilary/subsetForVal', file)
