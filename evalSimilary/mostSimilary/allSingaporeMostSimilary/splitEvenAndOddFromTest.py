...
# 示例用法
input_hdf5 = 'dataset/grab_possi/grab_possi_Singapore_all/allProcessedSingapore.hdf5'  # 输入的HDF5文件
key_txt = 'dataGenerate/allSingaporeGenerate/allSingaporeTest.txt'  # 包含轨迹键的txt文件
even_hdf5 = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/database_data.hdf5'  # 偶数点HDF5文件
odd_hdf5 = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/query_data.hdf5'  # 奇数点HDF5文件
even_txt = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/database_data.txt'  # 偶数点的轨迹键txt文件
odd_txt = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/query_data.txt'  # 奇数点的轨迹键txt文件
