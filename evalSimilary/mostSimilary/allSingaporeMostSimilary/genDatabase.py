...
all_data_hdf5 = 'dataset/grab_possi/grab_possi_Singapore_all/allProcessedSingapore.hdf5'  # 被追加的轨迹，也就是完整的HDF5文件
even_txt = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/database_data.txt'      # 包含偶数点轨迹键的txt文件
new_hdf5 = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/true_database_data.hdf5'  # 包含偶数点轨迹以及追加的轨迹
new_txt = 'evalSimilary/mostSimilary/allSingaporeMostSimilary/true_database_data.txt'  # 包含所有轨迹键的txt文件
