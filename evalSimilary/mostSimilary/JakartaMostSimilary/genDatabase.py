...
even_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/database_data.txt'      # 包含偶数点轨迹键的txt文件
new_hdf5 = 'evalSimilary/mostSimilary/JakartaMostSimilary/true_database_data.hdf5'  # 包含偶数点轨迹以及追加的轨迹
new_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/true_database_data.txt'  # 包含所有轨迹键的txt文件
