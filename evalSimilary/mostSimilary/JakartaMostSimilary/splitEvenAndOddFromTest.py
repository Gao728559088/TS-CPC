...
# 示例用法
input_hdf5 = 'dataset/grab_possi/grab_possi_Jakarta_android/jakartaAndroid.hdf5'  # 输入的HDF5文件
key_txt = 'dataGenerate/jakartaAndroidGenerate/jakartaAndroidTest.txt'  # 包含轨迹键的txt文件
even_hdf5 = 'evalSimilary/mostSimilary/JakartaMostSimilary/database_data.hdf5'  # 偶数点HDF5文件
odd_hdf5 = 'evalSimilary/mostSimilary/JakartaMostSimilary/query_data.hdf5'  # 奇数点HDF5文件
even_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/database_data.txt'  # 偶数点的轨迹键txt文件
odd_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/query_data.txt'  # 奇数点的轨迹键txt文件

# 运行处理函数，最多随机抽取500条轨迹
process_hdf5_from_txt(input_hdf5, key_txt, even_hdf5, odd_hdf5, even_txt, odd_txt, max_trajectories=1300)
