...
from src.model.model import CDCK2ForJakartaAndroid
import os
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='bestModelPath/jakartaAndroid_1024_12_256_32.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/mostSimilary/JakartaMostSimilary/logs', help='Directory to save log files')
    args = parser.parse_args()


    query_hdf5 = 'evalSimilary/mostSimilary/JakartaMostSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/mostSimilary/JakartaMostSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/mostSimilary/JakartaMostSimilary/true_database_data.txt'
