...
from src.model.model import  CDCK2ForAllGeoLife, CDCK2ForSingapore
import logging,time
import os
...
def evaluate_model(args, list_txt,logger):
    try:
        ...
        # Load the model
        model = CDCK2ForAllGeoLife(args.timestep, args.batch_size, args.trajectory_window,6).to(device)
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='snapshot/geoLife/cdc-2024-09-30_10_14_22-model_best.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/mostSimilary/allGeolifeMostSimilary/logs', help='Directory to save log files')
    args = parser.parse_args()

    query_hdf5 = 'evalSimilary/mostSimilary/allGeolifeMostSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/mostSimilary/allGeolifeMostSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/mostSimilary/allGeolifeMostSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/mostSimilary/allGeolifeMostSimilary/true_database_data.txt'
