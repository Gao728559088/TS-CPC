...
# 示例用法
input_hdf5 = 'dataset/grab_possi/grab_possi_Singapore_ios/singapore.hdf5' # 将ios大于1024的轨迹数据集进行划分，也就是在训练ios过程中所用的数据集
even_hdf5 = 'evalSimilary/mostSimilary/singaporeMostSimilary/database_data.hdf5'  # 将偶数点放入到数据库，作为数据库数据
odd_hdf5 = 'evalSimilary/mostSimilary/singaporeMostSimilary/query_data.hdf5' # 将奇数点作为查询数据
even_txt = 'evalSimilary/mostSimilary/singaporeMostSimilary/database_data.txt'
odd_txt = 'evalSimilary/mostSimilary/singaporeMostSimilary/query_data.txt'
