...
def calculate_mean_rank(rank_matrix):
    ...
    for i in range(num_vectors):
            ...
            if (rank_matrix[i, i].item() == 0 ):  
                ...
                ranks.append(rank_matrix[i, i].item())
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='bestModelPath/singaporeIos_1024_12_128_32.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/mostSimilary/singaporeMostSimilary/logs', help='Directory to save log files')
    args = parser.parse_args()

    query_hdf5 = 'evalSimilary/mostSimilary/singaporeMostSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/mostSimilary/singaporeMostSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/mostSimilary/singaporeMostSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/mostSimilary/singaporeMostSimilary/true_database_data.txt'
