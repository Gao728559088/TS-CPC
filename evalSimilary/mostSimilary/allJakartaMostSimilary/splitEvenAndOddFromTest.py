...
# 示例用法
input_hdf5 = 'dataset/grab_possi/grab_possi_Jakarta_all/allJakarta.hdf5'  # 输入的HDF5文件
key_txt = 'dataGenerate/allJakartaGenerate/allJakartaTest.txt'  # 包含轨迹键的txt文件
even_hdf5 = 'evalSimilary/mostSimilary/allJakartaMostSimilary/database_data.hdf5'  # 偶数点HDF5文件
odd_hdf5 = 'evalSimilary/mostSimilary/allJakartaMostSimilary/query_data.hdf5'  # 奇数点HDF5文件
even_txt = 'evalSimilary/mostSimilary/allJakartaMostSimilary/database_data.txt'  # 偶数点的轨迹键txt文件
odd_txt = 'evalSimilary/mostSimilary/allJakartaMostSimilary/query_data.txt'  # 奇数点的轨迹键txt文件
