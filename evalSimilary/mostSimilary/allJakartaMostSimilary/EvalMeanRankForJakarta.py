...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='snapshot/jakarta/cdc-2024-10-02_16_53_54-model_best.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/mostSimilary/allJakartaMostSimilary/logs', help='Directory to save log files')
    args = parser.parse_args()

    query_hdf5 = 'evalSimilary/mostSimilary/allJakartaMostSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/mostSimilary/allJakartaMostSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/mostSimilary/allJakartaMostSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/mostSimilary/allJakartaMostSimilary/true_database_data.txt'
