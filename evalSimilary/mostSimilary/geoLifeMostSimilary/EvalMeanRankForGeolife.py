...
def evaluate_model(args, list_txt,logger):
    try:
        ...
        dataset = RawDatasetGeoLife(args.raw_hdf5, list_txt,args.trajectory_window)
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='bestModelPath/cdc-2024-09-09_23_24_04-model_best.pth', help='Path to the trained model file')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/mostSimilary/geoLifeMostSimilary/logs', help='Directory to save log files')
    args = parser.parse_args()

    query_hdf5 = 'evalSimilary/mostSimilary/geoLifeMostSimilary/query_data.hdf5'
    query_txt = 'evalSimilary/mostSimilary/geoLifeMostSimilary/query_data.txt'
    database_hdf5 = 'evalSimilary/mostSimilary/geoLifeMostSimilary/true_database_data.hdf5'
    database_txt = 'evalSimilary/mostSimilary/geoLifeMostSimilary/true_database_data.txt'
