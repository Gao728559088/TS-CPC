...
from src.model.model import CDCK2ForJakartaIos, CDCK2ForSingapore
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='snapshot/jakartaIos/cdc-2024-09-06_10_11_22-model_best.pth', help='Path to the trained model file')
    parser.add_argument('--raw-hdf5', type=str, default='dataset/grab_possi/grab_possi_Jakarta_ios/jakartaIos.hdf5', help='Path to the HDF5 file containing raw data')
    ...
    parser.add_argument('--log-dir', type=str, default='evalSimilary/jakartaIosSimilary/logs', help='Directory to save log files')
    parser.add_argument('--output-dir', type=str, default='evalSimilary/jakartaIosSimilary/heatmaps', help='Directory to save heatmap images')
    args = parser.parse_args()
    
    logger = setup_logger(args.log_dir)
    
    files = [f for f in os.listdir('evalSimilary/jakartaIosSimilary/subsetForVal') if f.endswith('.hdf5')]
    mean_ranks = []

    for file in files:
        hdf5_file = os.path.join('evalSimilary/jakartaIosSimilary/subsetForVal', file)
