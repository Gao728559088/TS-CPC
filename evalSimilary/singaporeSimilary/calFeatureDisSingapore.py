...
from src.model.model import CDCK2ForSingapore, CDCK2ForSingapore1
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='snapshot/singapore/cdc-2024-09-06_20_24_29-model_best.pth', help='Path to the trained model file')
    parser.add_argument('--raw-hdf5', type=str, default='', help='Path to the HDF5 file containing raw data')
    ...
    files = [f for f in os.listdir('evalSimilary/singaporeSimilary/subsetForVal') if f.endswith('.hdf5')]
    mean_ranks = []

    for file in files:
        hdf5_file = os.path.join('evalSimilary/singaporeSimilary/subsetForVal', file)
