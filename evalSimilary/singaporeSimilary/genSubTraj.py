...
def main():
    hdf5_file = 'dataset/grab_possi/grab_possi_Singapore_ios/singapore.hdf5'  # 替换为HDF5文件的路径
    output_file_base = 'evalSimilary/singaporeSimilary/subsetForVal/singapore_subset'  # 输出文件的基本名称
    n = 4000  # 随机抽取的轨迹数量
