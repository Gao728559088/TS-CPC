...
def main():
    hdf5_file = 'dataset/grab_possi/grab_possi_Singapore_ios/singapore.hdf5'  # HDF5文件路径
    txt_file = 'dataGenerate/singaporeIosGenerate/singaporeTest.txt'  # 包含轨迹ID的txt文件
    output_file = 'evalSimilary/singaporeSimilary/subsetForVal/singapore_subset.hdf5'  # 输出文件路径
