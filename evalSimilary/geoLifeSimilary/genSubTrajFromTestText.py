...
def main():
    hdf5_file = 'dataset/geoLife/processedGeolife.hdf5'  # HDF5文件路径
    txt_file = 'dataGenerate/geoLifeGenerate/geoLifeTest.txt'  # 包含轨迹ID的txt文件
    output_file = 'evalSimilary/geoLifeSimilary/subsetForVal/geoLife_subset.hdf5'  # 输出文件路径
