...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Singapore_all/allProcessedSingapore.hdf5')
    parser.add_argument('--train', default='dataGenerate/allSingaporeGenerate/allSingaporeTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/allSingaporeGenerate/allSingaporeVal.txt')
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[4], help='List of GPUs to use (e.g., --gpus 0 1)')
