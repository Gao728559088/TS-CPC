...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Jakarta_all_new/ios/allJakartaByIos.hdf5')
    parser.add_argument('--train', default='dataGenerate/allJakartaByIosCMGenerate/allJakartaCMByIosTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/allJakartaByIosCMGenerate/allJakartaCMByIosVal.txt')
 

    parser.add_argument('--logging-dir', default='snapshot/jakartaCMByIos/', help='model save directory')
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[7], help='List of GPUs to use (e.g., --gpus 0 1)')
