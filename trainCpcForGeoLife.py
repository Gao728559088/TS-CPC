...
def main():
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[2], help='List of GPUs to use (e.g., --gpus 0 1)')
    ...
    # 加载数据集
    training_set= RawDatasetGeoLife(args.raw,args.train ,args.trajectory_window)
    validation_set = RawDatasetGeoLife(args.raw, args.validation,args.trajectory_window)
