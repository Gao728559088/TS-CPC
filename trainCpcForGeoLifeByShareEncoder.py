...
from src.training_v1 import   snapshot, trainReverse
from src.validation_v1 import  validationReverse
from src.model.model import  CDCK6ForGeoLife
...
def main():
    ...
    parser.add_argument('--raw', default='dataset/geoLife/processedGeolife.hdf5')
    parser.add_argument('--train', default='dataGenerate/geoLifeGenerate/geoLifeTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/geoLifeGenerate/geoLifeVal.txt')

    parser.add_argument('--logging-dir', default='snapshot/geoLife', help='model save directory')
    ...
    # 指定从每个轨迹中采样的窗口长度
    parser.add_argument('--trajectory-window', type=int, default=512)
    ...
    if torch.cuda.is_available() and not args.no_cuda:
        ...
        model = CDCK6ForGeoLife(args.timestep, args.batch_size, args.trajectory_window,6).to(device)
    ...
    logger.info('===> loading tsne-visualize, from the best model')
