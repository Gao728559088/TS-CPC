...
from src.model.model import CDCK2, CDCK5, CDCK2ForJakartaAndroid, CDCK2ForJakartaIos, CDCK2ForSingapore
...
def main():
    ...
    parser.add_argument('--logging-dir', default='snapshot/jakartaAndroid/', help='model save directory')
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[2,3], help='List of GPUs to use (e.g., --gpus 0 1)')
    ...
    if torch.cuda.is_available() and not args.no_cuda:
        ...
        model = CDCK2ForJakartaAndroid(args.timestep, args.batch_size, args.trajectory_window).to(device)
