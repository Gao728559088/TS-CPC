...
def main():
    plt_dir = 'dataset/grab_possi/grab_possi_Singapore_andorid/pltFiles'  # 替换为你的 plt 文件目录
    hdf5_filename = 'dataGenerate/singaporeAndroidGenerate/singaporeAndroid.hdf5'  # 替换为你想存储 hdf5 文件的路径
