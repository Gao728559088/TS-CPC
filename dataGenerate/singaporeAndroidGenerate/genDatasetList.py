...
# HDF5文件路径
h5_file_path = 'dataGenerate/singaporeAndroidGenerate/singaporeAndroid.hdf5'

# 生成列表文件
extract_datasets_to_list(h5_file_path, 'dataGenerate/singaporeAndroidGenerate/singaporeAndroid.txt')
