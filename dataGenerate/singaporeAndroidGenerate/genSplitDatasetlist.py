...
def main():
    ...
    parser.add_argument('--list_file', type=str, default='dataGenerate/singaporeAndroidGenerate/singaporeAndroid.txt',help='DataSetList.txt')
    parser.add_argument('--train_file', type=str, default='dataGenerate/singaporeAndroidGenerate/singaporeAndroidTrain.txt', help='Filename for the training set')
    parser.add_argument('--valid_file', type=str, default='dataGenerate/singaporeAndroidGenerate/singaporeAndroidVal.txt', help='Filename for the validation set')
    parser.add_argument('--test_file', type=str, default='dataGenerate/singaporeAndroidGenerate/singaporeAndroidTest.txt', help='Filename for the test set')
