...
# HDF5文件路径
h5_file_path = 'dataset/grab_possi/grab_possi_Singapore_all/allProcessedSingapore.hdf5'

# 生成列表文件
extract_datasets_to_list(h5_file_path, 'dataGenerate/allSingaporeGenerate/allSingapore.txt')
