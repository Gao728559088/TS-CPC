...
def main():
    ...
    hdf5_filename = 'dataset/geoLife/geoLifeLessFeature.hdf5'  # 替换为你想存储hdf5文件的目录
    convert_all_to_hdf5(base_dir, hdf5_filename,min_points=200,max_points=1024)  # 数据点数少于2000的轨迹将被丢弃
