...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Jakarta_all/allAndroidJakarta.hdf5')
    parser.add_argument('--train', default='dataGenerate/allJakartaGenerate/jakartaTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/allJakartaGenerate/jakartaVal.txt')
