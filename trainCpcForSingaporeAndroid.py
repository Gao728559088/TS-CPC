...
def main():
    ...
    parser.add_argument('--raw', default='dataGenerate/singaporeAndroidGenerate/singaporeAndroid.hdf5')
    parser.add_argument('--train', default='dataGenerate/singaporeAndroidGenerate/singaporeAndroidTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/singaporeAndroidGenerate/singaporeAndroidVal.txt')
 

    parser.add_argument('--logging-dir', default='snapshot/singaporeAndroid/', help='model save directory')
    ...
    parser.add_argument('--gpus', nargs='+', type=int, default=[0,1,2,3], help='List of GPUs to use (e.g., --gpus 0 1)')
