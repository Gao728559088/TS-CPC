...
def main():
    ...
    parser.add_argument('--raw', default='dataset/grab_possi/grab_possi_Jakarta_all/allJakarta.hdf5')
    parser.add_argument('--train', default='dataGenerate/allJakartaGenerate/allJakartaTrain.txt')
    parser.add_argument('--validation', default='dataGenerate/allJakartaGenerate/allJakartaVal.txt')
 

    parser.add_argument('--logging-dir', default='snapshot/jakarta/', help='model save directory')
